            ...
            <div className="grid items-center gap-12 lg:grid-cols-2 lg:gap-16">
              ...
              >
                <p className="text-sm leading-7 text-gray-300 sm:text-base lg:text-lg lg:leading-8">
                  ...
                  technology solutions that improve efficiency, optimize
                ...
                <p className="mt-6 text-sm leading-7 text-gray-300 sm:text-base lg:text-lg lg:leading-8">
                  ...
                  <span className="font-medium text-white">
                    AI, IoT, cloud computing, and data analytics
                  </span>{" "}
                  to enable real-time monitoring, intelligent automation,
                  predictive insights, and smarter energy management. This
                  helps organizations reduce costs, improve reliability, and
                  make better decisions.
                </p>

                <p className="mt-6 text-sm leading-7 text-gray-300 sm:text-base lg:text-lg lg:leading-8">
                  From power generation and utilities to renewable energy and
                  infrastructure, we deliver secure, scalable, and
                  future-ready solutions that support smarter operations and a
