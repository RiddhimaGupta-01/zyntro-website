            ...
            <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
              ...
              >
                <p className="text-sm leading-8 text-gray-300 sm:text-base lg:text-lg">
                  ...
                  scalable, and secure digital solutions. From custom software
                  and web applications to mobile apps, cloud solutions, and
                  enterprise systems, we deliver technology that improves
                  efficiency, enhances user experiences, and accelerates
                  business growth.
                </p>
